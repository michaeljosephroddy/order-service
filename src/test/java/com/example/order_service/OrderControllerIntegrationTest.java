...
public class OrderControllerIntegrationTest {
    ...
    void getOrder_ShouldReturnOrderDetails() throws Exception {
        ...
        Order order = orderRepository.save(new Order(null, customer.getId(), "Test Product", 1, LocalDateTime.now()));
    ...
    void deleteOrder_ShouldReturnSuccessMessage() throws Exception {
        // Given
        Customer customer = customerRepository
                .save(new Customer(null, "Charlie", "charlie." + System.currentTimeMillis() + "@example.com",
